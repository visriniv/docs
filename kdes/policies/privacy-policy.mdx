...
- **Account deletion**: Contact `Support@btsscorp.com` to close your account. BTSS removes Supabase authentication
...
email `Support@btsscorp.com` and BTSS will delete it promptly.
...
Submit requests via `Support@btsscorp.com`. BTSS responds within 30 days (or faster where laws require).
