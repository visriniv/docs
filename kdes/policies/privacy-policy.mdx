...
- **Account deletion**: Contact `privacy@btsscorp.com` to close your account. BTSS removes Supabase authentication
...
email `privacy@btsscorp.com` and BTSS will delete it promptly.
...
Submit requests via `privacy@btsscorp.com`. BTSS responds within 30 days (or faster where laws require).

## 9. Contact BTSS

Need more details or want to report a concern?

- **Email:** `privacy@btsscorp.com`
- **Support portal:** https://www.btsscorp.com/support
