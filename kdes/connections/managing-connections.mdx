...
- Drag connections up or down to reorder them—Koala remembers the order across sessions.
- Click the star icon to pin frequently used connections to the top of dropdowns.
