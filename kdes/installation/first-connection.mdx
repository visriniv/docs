...
1. Open Koala Studio.
2. Use the same Koala account you use for the VS Code extension (email OTP or SSO, depending on your tenant).
...
3. Save; the connection now appears in the tab selector and is synced to Supabase so other machines can reuse it.
