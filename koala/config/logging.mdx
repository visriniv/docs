...
When you encounter issues with Koala Data Explorer Extension, enabling diagnostic logs helps identify problems and collect information for support. The extension includes a built-in log viewer for easy troubleshooting.
