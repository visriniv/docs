...
Koala Data Explorer Extension's Excel export feature creates professional .xlsx files from your query results. This feature is available in the paid version and provides formatted spreadsheets ready for business use.
