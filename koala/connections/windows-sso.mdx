...
Koala Data Explorer Extension supports connecting to Oracle Fusion Cloud using your organization's existing SAML-based SSO. This is different from OAuth PKCE authentication - it works directly with Oracle Fusion's built-in SSO without requiring additional setup.
