...
## What is Koala Data Explorer Extension?

Koala Data Explorer Extension™ (KDEE) is a powerful VS Code extension that enables you to query Oracle Fusion Cloud data directly from your development environment. Built for developers, analysts, and consultants who work with Oracle Fusion, it provides instant access to your enterprise data without the need to navigate slow web portals or complex interfaces.
