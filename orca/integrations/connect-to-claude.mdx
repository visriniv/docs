...
<Steps>
  ...
  <Step title="Sign in to ORCA & approve a connection">
    ...
    <Frame><img src="/images/mcp-guide/approve-connection.png" alt="Approving an Oracle connection for the application in ORCA" /></Frame>
  </Step>
  <Step title="Allow the tools">
    Approve the tool permissions (**Always allow for all tools** is fine). Done — ask away in any chat.
    <Frame><img src="/images/mcp-guide/allow-tools.png" alt="Setting tool permissions to Always allow in Claude" /></Frame>
  </Step>
</Steps>
