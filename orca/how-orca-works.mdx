...
description: "The building blocks, the conversion lifecycle, and the Configuration Workbench"
---
...
Alongside conversion, the **Configuration Workbench** uses the same connections to manage Oracle setup across environments — migrate it from one to the next, detect what has drifted, push a targeted set of changes, and keep every state versioned.

<Card title="Use the Configuration Workbench" icon="sliders" href="/orca/workspace/configuration-workbench">
  Pull, review, check for drift, and push Oracle setup between environments.
</Card>
