...
Alongside conversion, the **Configuration Workbench** uses the same connections to move Oracle setup between environments — pull it out of one environment, edit it, and push it into another.
