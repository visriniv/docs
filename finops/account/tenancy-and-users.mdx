...
Koala FinOps is **multi-tenant**. Everything you do lives inside a **tenant** — one organization's isolated space, with its own connections, cost data, users, and settings. Each business unit sees only its own data, while platform admins keep central oversight.
